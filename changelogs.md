...
- **Projects Desktop Layout Overlap**: Assigned explicit inline flex layout styles, width, min-width, and flex-shrink properties to the Title Intro card in `Projects.jsx` to prevent it from overlapping with project cards on desktop screens.
